-- Reset da tabela para rodar do zero
...
-- Correção: colocar WHERE id = numero do id;

-- Query 2: DELETE FROM livros;
-- Não tem WHERE.
-- Apaga todos os registros da tabela de uma vez só.
-- Correção: colocar WHERE id = numero do id ou usar UPDATE com ativo = 0.
